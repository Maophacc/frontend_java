...
import { GET_ORDERS_BY_EMAIL, getBestEmail } from "../config/apiService";
...
const getOrderTotal = (o) => o?.bill?.total ?? o?.Bill?.Total ?? o?.totalAmount ?? o?.total ?? o?.orderTotal ?? o?.amount ?? 0;
...
const Order = () => {
    ...
    useEffect(() => {
        ...
        window.addEventListener("auth-change", fetchOrders);
        return () => window.removeEventListener("auth-change", fetchOrders);
                                                ...
                                                {pageOrders.map((o) => {
                                                    ...
                                                    return (
                                                        <tr
                                                            ...
                                                            onClick={() => navigate(`/profile/orders/${id}`)}
                                                        >
